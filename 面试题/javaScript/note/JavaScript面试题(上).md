...
下面看一下**双精度数是如何保存**的： ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221928223.webp)
...
其流程图如下： ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221929529.webp)
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值： ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221929067.webp) 数组里的0、1、2索引位的元素值，精准地被映射到了左侧的第0、1、2个变量里去，这就是数组解构的工作模式。还可以通过给左侧变量数组设置空占位的方式，实现对数组中某几个元素的精准提取：
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量： ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221929660.webp)
...
这样就得到了 name 和 age 两个和 stu 平级的变量： ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221929625.webp)
...
**特点：** JavaScript 对象是通过引用来传递的，创建的每个新对象实体中并没有一份属于自己的原型副本。当修改原型时，与之相关的对象也会继承这一改变。 ![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c68fcad75ea54d62a9404aa02cafc65c~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
由于`Object`是构造函数，原型链终点是`Object.prototype.__proto__`，而`Object.prototype.__proto__=== null // true`，所以，原型链的终点是`null`。原型链上的所有原型都是对象，所有的对象最终都是由`Object`构造的，而`Object.prototype`的下一级是`Object.prototype.__proto__`。 ![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221928408.webp)
...
![img](https://gitee.com/hnistzzm/typora-cloud-img/raw/master/202203221934780.webp)
